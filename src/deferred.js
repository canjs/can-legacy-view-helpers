// # can/view/deferred.js
// -------
// `can.view.deferred`
// Deferred is a Promises/A-compliant promise implementation with a jQuery-style interface
...
var wire = function(parentDeferred, result, setter, value){
	if( isDeferred(result) ) {
		result.done(parentDeferred.resolve.bind(parentDeferred))
			.fail(parentDeferred.reject.bind(parentDeferred) );
	} else {
